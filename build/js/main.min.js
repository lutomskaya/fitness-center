...
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/scroll */ "./js/modules/scroll.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_2__["setupVideo"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["toggleTabs"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["coachesSlider"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["reviewsSlider"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["checkInputName"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["checkInputPhone"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_6__["initScroll"])();
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: checkInputPhone, checkInputName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkInputPhone", function() { return checkInputPhone; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkInputName", function() { return checkInputName; });
function checkInputPhone() {
  var phoneInput = document.querySelectorAll('input[data-phone-input]');
  phoneInput.forEach(function (item) {
    item.addEventListener('input', function () {
      var value = item.value.replace(/[^0-9\s)(+)-]/g, '');
      var numberLength = 11;
      var result = '';
...
function checkInputName() {
  var nameInput = document.querySelectorAll('input[data-name-input]');
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: coachesSlider, reviewsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var coachesSlider = function coachesSlider() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper="coaches"]', {
...
var reviewsSlider = function reviewsSlider() {
  if (!swiperContainer) {
    ...
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper="reviews"]', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
      direction: 'horizontal',
      slidesPerView: 1,
      loop: false,
...
var tabsButton = document.querySelectorAll('[data-tab-button]');
var tabsContent = document.querySelectorAll('[data-tab-content]');
var toggleTabs = function toggleTabs() {
  tabsButton.forEach(function (control) {
    control.addEventListener('click', function (evt) {
      evt.preventDefault();
      var currentButton = control.getAttribute('data-tab-button');
      var currentContent = document.querySelector("[data-tab-content=\"".concat(currentButton, "\"]"));
      ...
      for (var _i = 0; _i < tabsContent.length; _i++) {
        if (tabsContent[_i].classList.contains('subscriptions__list--active')) {
          tabsContent[_i].classList.remove('subscriptions__list--active');
          break;
        }
      }
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: setupVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setupVideo", function() { return setupVideo; });
var videoElement = document.querySelector('[data-video]');
var link = videoElement.querySelector('[data-video-link]');
var button = videoElement.querySelector('[data-video-button]');
var generateURL = function generateURL() {
  if (!videoElement) {
    return '';
  }
  var url = videoElement.getAttribute('data-url');
